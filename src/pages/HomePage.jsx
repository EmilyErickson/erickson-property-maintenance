...
function HomePage() {
    return (
            <div className="home-page">
                ...
                <Carousel />
                <p className="facebook-link">Visit us on <a href="https://www.facebook.com/profile.php/?id=100092508355179" target="_blank" className="facebook-a">Facebook</a> to see what other customers are saying!</p>
